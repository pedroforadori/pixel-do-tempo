    ...
    <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/#inicio" className="flex items-center gap-2.5">
          <Image src="/logo-light.png" alt="" width={240} height={417} priority unoptimized className="h-9 w-auto dark:hidden" />
          <Image src="/logo-dark.png" alt="" width={122} height={205} priority unoptimized className="h-9 w-auto hidden dark:block" />
